...
public partial class HotelReservationSystemDBContext : DbContext
{
    public HotelReservationSystemDBContext(DbContextOptions<HotelReservationSystemDBContext> options)
        : base(options)
    {
    }
